...
namespace Contractor.Core
{
    public class EpaOGenerator
    {
        ...
        protected bool withReturnValueExpr;
        protected Dictionary<string, ErrorInstrumentator.MethodInfo> methodsInfo;

        public EpaOGenerator(IAnalyzer analyzer, int cutter, Dictionary<string, ErrorInstrumentator.MethodInfo> methods, bool withReturnValueExpr)
        {
            Contract.Requires(analyzer != null);
            this.analyzer = analyzer;
            this.cutter = cutter;
            this.withReturnValueExpr = withReturnValueExpr;
            this.methodsInfo = methods;
        }
