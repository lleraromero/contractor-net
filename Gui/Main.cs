...
namespace Contractor.Gui
{
    internal partial class Main : Form, IMainScreen
    {
        ...
        public Main()
        {
            ...
            options = new Options();
            mainPresenter = new MainPresenter(SynchronizationContext.Current, this);
        }
        ...
        protected void OnStartAnalysis(object sender, EventArgs e)
        {
            if (StartAnalysis != null)
            {
                ...
                var analysisArgs = new AnalysisEventArgs(selectedType, methodFilterPresenter.SelectedMethods());
