...
namespace Examples.Zoppi
{
	...
	public class ArrayList : IList, ICollection, IEnumerable, ICloneable
	{
		...
		public ArrayList(int capacity)
		{
			...
			Contract.Ensures((capacity >= 0) ? (this.Capacity >= capacity) : true);
			Contract.Ensures(!this.IsReadOnly);
			Contract.Ensures(!this.IsFixedSize);
			if (capacity < 0)
			{
		...
		public virtual int BinarySearch(int index, int count, object value, IComparer comparer)
		{
			...
			Contract.Ensures((~Contract.Result<int>() - index) <= count);
			Contract.Ensures((Contract.Result<int>() < index) ? (~Contract.Result<int>() >= index) : true);
			if ((index < 0) || (count < 0))
			{
				throw new ArgumentOutOfRangeException((index >= 0) ? "count" : "index", ("ArgumentOutOfRange_NeedNonNegNum"));
			}
		...
		public virtual int IndexOf(object value, int startIndex, int count)
		{
			...
			Contract.Requires((startIndex + count) <= this.Count);
			Contract.Ensures(-1 <= Contract.Result<int>());
			Contract.Ensures(Contract.Result<int>() < this.Count);
			if (startIndex > this._size)
			{
		...
		public virtual int LastIndexOf(object value, int startIndex, int count)
		{
			...
			{
				throw new ArgumentOutOfRangeException((startIndex >= 0) ? "count" : "startIndex", ("ArgumentOutOfRange_NeedNonNegNum"));
			}
			if (this._size == 0)
			{
				return -1;
			...
			{
				throw new ArgumentOutOfRangeException((startIndex < this._size) ? "count" : "startIndex", ("ArgumentOutOfRange_BiggerThanCollection"));
			}
		...
		public static ArrayList Repeat(object value, int count)
		{
			...
			ArrayList list = new ArrayList((count <= 4) ? 4 : count);
		...
		public virtual void SetRange(int index, ICollection c)
		{
			Contract.Requires(c != null);
			Contract.Requires(index >= 0);
			Contract.Requires((index + c.Count) <= this.Count);
			if (c == null)
			{
				throw new ArgumentNullException("c", ("ArgumentNull_Collection"));
			}
		...
		private class IListWrapper : ArrayList
		{
			...
			public override void CopyTo(int index, Array array, int arrayIndex, int count)
			{
				...
				{
					throw new ArgumentOutOfRangeException((index >= 0) ? "arrayIndex" : "index", ("ArgumentOutOfRange_NeedNonNegNum"));
				}
				if (count < 0)
				{
					throw new ArgumentOutOfRangeException("count", ("ArgumentOutOfRange_NeedNonNegNum"));
