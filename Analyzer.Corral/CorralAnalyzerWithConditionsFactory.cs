...
{
    public class CorralAnalyzerWithConditionsFactory : IAnalyzerFactory
    {
        ...
        public CorralAnalyzerWithConditionsFactory(string defaultArgs, DirectoryInfo workingDir, List<string> errorListForQueryGenerator, CciAssembly inputAssembly,
        ...
        public IAnalyzer CreateAnalyzer()
        {
            ...
            return new AnalyzerWithCondition(defaultArgs, workingDir, queryGenerator, inputAssembly, inputFileName,
